...
INSERT INTO usuarios (id, nome, email, cargo, meta_mensal_os, percentual_comissao) VALUES
  ('11111111-1111-1111-1111-111111111111', 'Carlos Gerente', 'gerente@fitch.com', 'gerente', 0, 0.00),
  ('22222222-2222-2222-2222-222222222222', 'Pedro Vendedor', 'pedro.vendas@fitch.com', 'vendedor', 20, 5.00),
  ('33333333-3333-3333-3333-333333333333', 'Ana Vendedora', 'ana.vendas@fitch.com', 'vendedor', 20, 5.00),
  ('44444444-4444-4444-4444-444444444444', 'Marcos Técnico', 'marcos.tecnico@fitch.com', 'tecnico', 0, 0.00)
